...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">{{ isset($product) ? 'Edit Product' : 'Add Product' }}</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('product') }}" class="btn btn-sm btn-info">Product Lists</a>
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="card-body">
        <form action="{{ isset($product) ? route('product.update', $product->id) : route('product.store') }}"
            ...
            <div class="form-group mt-3">
                <button type="submit" class="btn btn-success" {{ Route::currentRouteName() === 'product.view' ? 'disabled' : '' }}>Submit</button>
                <button type="button" class="btn btn-danger" onclick="window.location.href='{{ route('product') }}'">Cancel</button>
            </div>
        </form>
    </div>
</div>
